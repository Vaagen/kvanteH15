...
enum Situation{FREE_ELECTRON_1D, FREE_ELECTRON_2D, ELECTRON_CONST_BARRIER_1D, ELECTRON_TRIANGLE_1D, ELECTRON_CONST_BARRIER_2D, ELECTRON_MULTIPLE_SLIT_2D};
enum Potential{FREE,CONST_BARRIER_1D,TRIANGLE_1D, CONST_BARRIER_2D, MULTIPLE_SLIT_2D};
